...
\begin{center}
	\begin{tabular}{l p{10.5cm}}
		...
		\textbf{Current Version:} & MACS V1.2 \begin{tabular}{l} \includegraphics[scale=0.3]{../Figures/DOI_V11.png} \end{tabular} \\
...
\item
Soch J (2018). cvBMS and cvBMA: filling in the gaps. Technical Report, in preparation, will be available from \textit{arXiv}.
