...
\begin{center}
	\begin{tabular}{l p{10.5cm}}
		...
		\textbf{Toolbox Paper:} & Soch J, Allefeld C (in review). MACS -- a new SPM toolbox for model assessment, comparison and selection. \textit{Journal of Neuroscience Methods}, in review, available at \textit{bioRxiv}; DOI: 10.1101/194365. \\
	\end{tabular}
\end{center}
\vspace*{1em}
